...
<template>
  ...
  <div class="galleryCategoryMenu">
    <ul>
        <li class="portraits"><a href="#">PORTRAITS<span></span></a></li>
        <li class="sports"><a href="#">SPORTS<span></span></a></li>
        <li class="weddings"><a href="#">WEDDINGS<span></span></a></li>
        <li class="celebrations"><a href="#">CELEBRATIONS<span></span></a></li>
        <li class="animals"><a href="#">ANIMALS<span></span></a></li>
        <li class="personal"><a href="#">PERSONAL<span></span></a></li>
    </ul>
    </div>
</template>
...
background: url('https://www.seanhartphotography.co.nz/wp-content/uploads/2014/09/menu-sprites2.png');
}
